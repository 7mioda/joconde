...
export function CopyTaskForm({ taskId, onSubmit, onCancel, isLoading = false }: CopyTaskFormProps) {
  const task = useTask(taskId)
  const [formData, setFormData] = React.useState<CopyTaskFormValues>({
    title: task?.title ?? "",
  ...
  const handleInputChange = (field: keyof CopyTaskFormValues, value: string) => {
