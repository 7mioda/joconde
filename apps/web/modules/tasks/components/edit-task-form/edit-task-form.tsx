...
interface EditTaskFormProps {
  initialData?: EditTaskFormValues;
  onSubmit?: (data: EditTaskFormValues) => void
  onCancel?: () => void
  isLoading?: boolean
}

export function EditTaskForm({ initialData, onSubmit, onCancel, isLoading = false }: EditTaskFormProps) {
  ...
  const validateForm = (values: EditTaskFormValues) => {
    try {
  ...
  return (
    ...
    >
      {({ values, setFieldValue, errors, touched }: FormikProps<EditTaskFormValues>) => (
