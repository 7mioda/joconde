...
interface AddTaskFormProps {
  onSubmit?: (data: AddTaskFormValues) => void
  onCancel?: () => void
  isLoading?: boolean
}

export function AddTaskForm({ onSubmit, onCancel, isLoading = false }: AddTaskFormProps) {
  const [formData, setFormData] = React.useState<AddTaskFormValues>({
    title: "",
    description: "",
    status: "todo",
    label: "feature",
  ...
  const handleInputChange = (field: keyof AddTaskFormValues, value: string) => {
